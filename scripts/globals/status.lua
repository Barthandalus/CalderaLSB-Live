...
xi.effect =
{
    ...
    SUBTLE_SORCERY           = 493,
    STYMIE                   = 494,
    RUN_WILD                 = 495, -- (None) DEBUG: Please report. Caldera custom assigned to Run Wild
    INTERVENE                = 496,
    ...
    BOUNTY_SHOT              = 506, -- (None) DEBUG: Please report. Caldera custom assigned to Bounty Shot
    GRAND_PAS                = 507,
    WIDENED_COMPASS          = 508,
    ...
    IONIS                    = 512,
    BOLSTER                  = 513,
    NIGHTMARE                = 514, -- (None) DEBUG: Please report. Caldera custom assigned to Nightmare
    LASTING_EMANATION        = 515,
    ECLIPTIC_ATTRITION       = 516,
    COLLIMATED_FERVOR        = 517,
    DEMATERIALIZE            = 518,
    THEURGIC_FOCUS           = 519,
    HEADY_ARTIFICE           = 520, -- (None) DEBUG: Please report. Caldera custom assigned to Heady Artifice
    -- NONE                     = 521, -- (None) DEBUG: Please report.
    ...
    TAINT                    = 630,
    HAUNT                    = 631,
    ZEALOUS_SNORT            = 632, -- (None) DEBUG: Please report. Caldera custom assigned to Zealous Snort
    FAMILIAR                 = 633, -- (None) DEBUG: Please report. Caldera custom assigned to Familiar
...
xi.mod =
{
    ...
    UTSU_ATK_SHADOWS                = 3303, -- Adds Attack for each Utsusemi Shadow Image present
}
